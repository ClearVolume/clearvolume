                                              ...
                                              ClearVolumeCloseable
{
  ...
  public ClearVolumeRendererBase(final int pNumberOfRenderLayers)
  {
    ...
    /*GmailBadTrackNotifier lEmailNotifier = new GmailBadTrackNotifier(	"ClearVolumeErrors@gmail.com",
    																																	"ClearVolumeIsCool");/**/

    if (sBadTrack == null)
    {
      sBadTrack = new BadTrack("ClearVolume", null);
      ...
      sBadTrack.askWithSwing("Help Improve ClearVolume",
                             "ClearVolume uses your graphics card (GPU) to perform volumetric rendering of your stacks. \n"
                                                         ...
                                                         + "The report only contains technical details about your machine (OS, CPU and graphics card(s)) \n"
