...
public class OpenCLVolumeRenderer extends ClearGLVolumeRenderer implements
	...
	protected boolean initVolumeRenderer() {
		...
		mCLDevice.initCL();
		mCLDevice.printInfo();
		mMaxProjectionRenderKernel = mCLDevice.compileKernel(
				OpenCLVolumeRenderer.class
						.getResource("kernels/VolumeRender.cl"),
				"maxproj_render");
		mClearKernel = mCLDevice.compileKernel(OpenCLVolumeRenderer.class
				.getResource("kernels/VolumeRender.cl"), "clearbuffer");

		mIsoSurfaceRenderKernel = mCLDevice.compileKernel(
				OpenCLVolumeRenderer.class
						.getResource("kernels/VolumeRender.cl"),
				"isosurface_render");
