...
public class OpenCLHistogram_old extends OpenCLProcessor<IntBuffer>
{
	...
	public void ensureOpenCLInitialized()
	{
		if (mKernelHist == null)
		{
			mKernelHist = getDevice().compileKernel(OpenCLHistogram_old.class.getResource("kernels/histogram.cl"),
																							"histogram");
		}
